        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerChildren} className="text-center lg:text-left">
              ...
              <div className='lg:flex-col flex gap-5'>
      ...
      <section id="committees" className="py-20 bg-white/80 backdrop-filter backdrop-blur-md">
        <div className="mt-20 container mx-auto px-6">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInUp}
            className="lg:flex-col flex justify-center gap-4 mb-12"
          >
            <Button
...
<p className="text-base text-gray-600 max-w-xl mb-10 mx-auto">
  ...
  From event highlights to important announcements, this is where the buzz happens — follow along and never miss a moment!
      ...
      <button
        onClick={nextReel}
        className="absolute bottom-4 text-3xl left-1/2 -translate-x-1/2 bg-black/20 hover:bg-black/40 text-black p-2 rounded-full"
      >
        ↓
      </button>
    </div>
